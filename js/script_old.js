document.addEventListener('DOMContentLoaded', () => {
    ...
    const shouldShowLoader = !hasVisited;
    
    console.log("[Loader Check] shouldShowLoader:", shouldShowLoader);

    // === Enhanced Loader Creation ===
    ...
    function initMagneticEffects() {
        const magneticElements = document.querySelectorAll('.cta-button, .modern-button, .mv-card');
    ...
    function initScrollAnimations() {
        const animatedElements = document.querySelectorAll('.section-title, .hero-content h2, .hero-content p, .cta-button');
    ...
    function showPageContent() {
        ...
        if (pageContent) {
            ...
            // Initialize features after content is visible
            setTimeout(() => {
    ...
    // === Loader Management ===
    if (shouldShowLoader && loaderWrapper) {
        ...
        // Show content immediately if no loader
        if (loaderWrapper) {
            loaderWrapper.style.display = 'none';
        }
        showPageContent();
